...
from myinventory import app, db
from myinventory.forms import addproduct, addlocation, moveproduct, editproduct, editlocation
from myinventory.models import Location, Product, Movement, Balance
